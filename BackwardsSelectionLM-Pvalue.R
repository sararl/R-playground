#####################################################
### backwards selection based on pvalue

#
# INPUT: predictors: string vector with predictors names
#        dependantValue: string
#        dataset
# OUTPUT: predictors names resultant of backwards selection based on pvalue



BackwardsPredictorsSelectionpValue<-function(predictors,dependantValue,dataset){
  maxCoef = 1
  while(maxCoef>=0.05){
...
#BackwardsPredictorsSelectionpValue(predictors,dependantValue,boston)
